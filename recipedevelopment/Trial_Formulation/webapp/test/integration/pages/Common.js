sap.ui.define([
	...
	function getFrameUrl(sHashParameter, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Trial_Formulation/trial_formulation/app", ".html");
	...
	return Opa5.extend("Trial_Formulation.trial_formulation.test.integration.pages.Common", {
